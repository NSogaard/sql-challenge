...
SELECT dept_man.dept_no AS "Department Number", depts.dept_name AS "Department Name", dept_man.emp_no AS "Employee Number", epi.last_name AS "Last Name", epi.first_name AS "First Name"
...
SELECT dept_emp.dept_no AS "Department Number", dept_emp.emp_no AS "Employee Number", epi.last_name AS "Last Name", epi.first_name AS "First Name", depts.dept_name AS "Department Name"
...
SELECT dept_emp.emp_no AS "Employee Number", epi.last_name AS "Last Name", epi.first_name AS "First Name", depts.dept_name AS "Department Name"
FROM department_employees AS dept_emp
INNER JOIN departments AS depts ON depts.dept_no = dept_emp.dept_no
INNER JOIN employee_personal_info AS epi ON epi.emp_no = dept_emp.emp_no
...
SELECT dept_emp.emp_no AS "Employee Number", epi.last_name AS "Last Name", epi.first_name AS "First Name", depts.dept_name AS "Department Number"
FROM department_employees AS dept_emp
INNER JOIN departments AS depts ON depts.dept_no = dept_emp.dept_no
INNER JOIN employee_personal_info AS epi ON epi.emp_no = dept_emp.emp_no
